...
|------------|----------|----------|---------|
| **Bếp 3 Miền** | 40000 | 70000 | 40–70k |
| **Bún Cá Rô Bà Kỵ** | 40000 | 80000 | 40–80k |
| **Phở Vịt Quay** | 30000 | 60000 | 30–60k |
| **Cuốn Ngon** | 50000 | 90000 | 50–90k |
| **Nhà Hàng Tràng An** | 40000 | 80000 | 40–80k |
...
The prices will display as badges on restaurant cards (e.g., "40–80k").

## Technical Notes

- Stored as integers in VND (e.g., 40000 = 40k VND)
- Display format: `${min/1000}–${max/1000}k`
